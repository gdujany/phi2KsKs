...
store_dir_g2 = os.path.join(eos_root, 'lhcb/user/g/gdujany/phi2KsKs_noTrigger/')
store_dir_s = '~/phi2KsKs/files/'

inFiles = {}
inFiles['data2012_Ds'] = r.TFile(os.path.join(store_dir_s, 'Ds_Phi2KsKs_2012.root'))
inFiles['data2012_incl'] = r.TFile(os.path.join(store_dir_g2, 'data2012.root'))
...
names = [b.GetName() for b in trees['data2012_Ds'].GetListOfBranches()]
...
# ct.addTree('data2012_Ds', trees['data2012_Ds'], tree_cut = cut_Ds) #evtMax=50000
ct.addTree('data2012_incl', trees['data2012_incl'], tree_cut = cut) #evtMax=50000
# ct.addTree('phi2KsKs_Ds', trees['phi2KsKs_Ds'], cut_Ds)
