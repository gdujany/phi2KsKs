...
\title{Feasibility study on using $\phi \rightarrow K^0 \overline{K}^0$ at LHCb to test for CPT invariance}
...
%\vspace*{-.2cm}
\date{September 30, 2015\\ \vspace{0.5cm}
\vspace*{-.1cm}
\begin{columns}
...
\begin{center}
\includegraphics[width=.65\textwidth]{/home/soonja/lxplus/phi2KsKs/phi2KsKs/preliminaryStudies/time_res_Ds/UReco_2D.pdf}
\end{center}
